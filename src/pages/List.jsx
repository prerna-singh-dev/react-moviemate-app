...
function List({ from }) {
  ...
  return (
    <>
      ...
      <section className="columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-4 md:gap-10 p-4 sm:p-6 md:p-12">
            ...
            >
              <div className="break-inside-avoid mb-10">
                ...
                <div className="p-4 bg-gray-100">
                  <h3 className="text-base md:text-lg mb-5 line-clamp-1 overflow-hidden md:line-clamp-2">
